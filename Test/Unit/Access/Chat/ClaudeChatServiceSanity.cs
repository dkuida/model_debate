    ...
    public void SetUp()
    {
        string apiKey = Environment.GetEnvironmentVariable("ANTHROPIC_API_KEY")
            ?? throw new InvalidOperationException(
                ...
                "Set it to a valid Anthropic API key before running these sanity tests.");

        m_Service = new ClaudeChatService(apiKey, "claude-3-5-sonnet-20241022", NullLogger<ClaudeChatService>.Instance);
    }
